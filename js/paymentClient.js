		...
		complete: function () {
			...
			if (windowType != null && windowType != "") {
				...
				if (windowType == "0") {
					...
					if (((payType == "NO" || payType == "EQ") && (!paymentForm.elements["payOption"] || paymentForm.elements["payOption"].value != 'PURCHASE_OTP')) || (payType == "EW" && (paymentForm.elements["bankCode"] == undefined || paymentForm.elements["bankCode"].value == ''))) {
